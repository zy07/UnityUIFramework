...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public void Snap()
        {
            ...
            JumpToDataIndex(_snapDataIndex, snapJumpToOffset, snapCellCenterOffset, snapUseCellSpacing, snapTweenType, snapTweenTime, SnapJumpComplete, forceCalculateRange: true);
        }
        ...
        public void OnEndDrag(PointerEventData data)
        {
            ...
            if (forceSnapOnEndDrag && snapping)
            {
                Snap();
            }
        }
        ...
        void OnDisable()
        {
            ...
            // reset the snapping state when the scroller is disabled
            ResetSnap();
        }
